...
`https://gitlab.uw.edu.pl/python-tools/argpars <https://gitlab.uw.edu.pl/python-tools/argparse>`_
`https://gitlab.mimuw.edu.pl/python-tools/argparsee <https://gitlab.mimuw.edu.pl/python-tools/argparse>`_
